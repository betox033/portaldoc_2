...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('CHXTXUF8i2', 0, ($this->targetDirs[0].'/pools'));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('GGclu+PCid', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = ${($_ = isset($this->services['doctrine.dbal.connection_factory']) ? $this->services['doctrine.dbal.connection_factory'] : ($this->services['doctrine.dbal.connection_factory'] = new \Doctrine\Bundle\DoctrineBundle\ConnectionFactory([]))) && false ?: '_'}->createConnection(['driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => '', 'dbname' => 'robertor_portaldoc', 'user' => 'robertor_portaldoc', 'password' => 'kfr77hRiQO70wJtXKYk5', 'charset' => 'UTF8', 'driverOptions' => [1002 => 'SET sql_mode=(SELECT REPLACE(@@sql_mode,\'ONLY_FULL_GROUP_BY\',\'\'))'], 'serverVersion' => 5.0999999999999996447286321199499070644378662109375, 'defaultTableOptions' => []], $a, $c, ['enum' => 'string']);
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf_orm_default_d319b5f82322217f742b7b75252780451dcf3ef1b2bc6e5315edf740d2921f7b');
    ...
    {
        return $this->services['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('XQfLiy0M9V', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('JfLY9GLYfZ', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['fragment.listener'] = new \Symfony\Component\HttpKernel\EventListener\FragmentListener(${($_ = isset($this->services['uri_signer']) ? $this->services['uri_signer'] : ($this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('SO1coBhg725zmxyR2fQXLBRFJjfSDkb8wX6z0aIJLwvyrkP8Gah3DoA4'))) && false ?: '_'}, '/_fragment');
    }
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('SO1coBhg725zmxyR2fQXLBRFJjfSDkb8wX6z0aIJLwvyrkP8Gah3DoA4');
    }
    ...
    protected function getDefaultParameters()
    {
        return [
            ...
            'kernel.active_modules' => [
                ...
                60 => 'ps_accounts',
                61 => 'blockreassurance',
                62 => 'fieldthemecustomizer',
                63 => 'fieldsizechart',
                64 => 'fieldblocksearch',
                65 => 'fieldmegamenu',
                66 => 'fieldslideshow',
                67 => 'fieldpopupnewsletter',
                68 => 'fieldbrandslider',
                69 => 'fieldstaticblocks',
                70 => 'fieldstaticfooter',
                71 => 'fieldbestsellers',
                72 => 'fieldfeaturedproductslider',
                73 => 'fieldonecateproductslider',
                74 => 'fieldnewproductslider',
                75 => 'fieldproductcates',
                76 => 'fieldtabcateslider',
                77 => 'elevatezoom',
                78 => 'fieldtestimonials',
                79 => 'fieldvmegamenu',
                80 => 'productcomments',
                81 => 'fieldcompare',
                82 => 'fieldblockwishlist',
                83 => 'smartblog',
                84 => 'smartbloghomelatestnews',
                85 => 'smartblogrecentposts',
                86 => 'pd_homeslider',
                87 => 'pd_configstyles',
                88 => 'pd_logo',
                89 => 'pd_buscador_top',
            ...
            'database_port' => '',
            'database_name' => 'robertor_portaldoc',
            'database_user' => 'robertor_portaldoc',
            'database_password' => 'kfr77hRiQO70wJtXKYk5',
            'database_prefix' => 'ps_',
            ...
            'secret' => 'SO1coBhg725zmxyR2fQXLBRFJjfSDkb8wX6z0aIJLwvyrkP8Gah3DoA4',
            'ps_caching' => 'CacheMemcache',
            'ps_cache_enable' => false,
            'ps_creation_date' => '2021-04-14',
            'locale' => 'es-ES',
            'cookie_key' => 'JzerKRZhB77q4jXAukg4TqJWv5dYnykLTOqGQHeJQzn4JywMiTrf5g3f',
            'cookie_iv' => 'ALDbVZzV',
            'new_cookie_key' => 'def00000c3de079d1cf2a850d9c4e97cb18b0322916838c74ecd412df04e312aa34a00f7921ceee130d97952058f87ef9037577c108773a0c815b53307aa1b425209073d',
            'cache.driver' => 'array',
            ...
            'kernel.secret' => 'SO1coBhg725zmxyR2fQXLBRFJjfSDkb8wX6z0aIJLwvyrkP8Gah3DoA4',
