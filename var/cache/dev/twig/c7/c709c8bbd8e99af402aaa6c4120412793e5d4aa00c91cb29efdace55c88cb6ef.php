...
class __TwigTemplate_da5fa810d96e0d84ba7c0a3593426c9040b7856266d807fc977e5cfb3e84df8a extends Twig_Template
{
    ...
    <div class=\"showcase-card__right\">
      ...
      ";
            ...
            if ((($context["indexPageId"] ?? $this->getContext($context, "indexPageId")) && ($context["isGridDisplayed"] ?? $this->getContext($context, "isGridDisplayed")))) {
                ...
                echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getPath("admin_metas_edit", array("metaId" => ($context["indexPageId"] ?? $this->getContext($context, "indexPageId")))), "html", null, true);
                echo "\">";
...
{% block meta_showcase_card %}
  ...
  {% endif %}
{% endblock %}
", "@PrestaShop/Admin/Configure/ShopParameters/TrafficSeo/Meta/Blocks/meta_showcase_card.html.twig", "/home/robertor/public_html/portaldoc/src/PrestaShopBundle/Resources/views/Admin/Configure/ShopParameters/TrafficSeo/Meta/Blocks/meta_showcase_card.html.twig");
    }
}
