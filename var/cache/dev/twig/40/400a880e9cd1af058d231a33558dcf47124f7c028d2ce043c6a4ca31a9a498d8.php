...
class __TwigTemplate_b4c4da0f822e8fe4eabb17b2d30bad7340f572a873af73d3fa049fa10ba00878 extends Twig_Template
{
...
";
    ...
    public function block_grid_pagination($context, array $blocks = array())
    {
        ...
        // line 27
        echo "  ";
        if ((($this->getAttribute($this->getAttribute(($context["grid"] ?? $this->getContext($context, "grid")), "data", array()), "records_total", array()) > 10) || $this->getAttribute($this->getAttribute(($context["grid"] ?? $this->getContext($context, "grid")), "pagination", array()), "offset", array()))) {
            // line 28
            echo "    <div class=\"row\">
      <div class=\"col-md-12\">
        ";
...
($context["grid"] ?? $this->getContext($context, "grid")), "pagination", array()), "limit", array()), "offset" => $this->getAttribute($this->getAttribute(            // line 32
($context["grid"] ?? $this->getContext($context, "grid")), "pagination", array()), "offset", array()), "total" => $this->getAttribute($this->getAttribute(            // line 33
($context["grid"] ?? $this->getContext($context, "grid")), "data", array()), "records_total", array()), "caller_route" => $this->getAttribute($this->getAttribute($this->getAttribute(            // line 34
...
{% block grid_pagination %}
  ...
  {% endif %}
{% endblock %}
", "@PrestaShop/Admin/Common/Grid/Blocks/pagination.html.twig", "/home/robertor/public_html/portaldoc/src/PrestaShopBundle/Resources/views/Admin/Common/Grid/Blocks/pagination.html.twig");
    }
}
