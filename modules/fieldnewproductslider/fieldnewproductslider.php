...
class FieldNewProductSlider extends Module
{
	...
	public function uninstall()
	{
        ...
        private function _createConfigs()
        {
            ...
            $response &= Configuration::updateValue('FIELD_NEWPSL_COLUMNITEM', 1);
            $response &= Configuration::updateValue('FIELD_NEWPSL_MAXITEM', 4);
            ...
            $response &= Configuration::updateValue('FIELD_NEWPSL_PAUSEONHOVER', 0);
            $response &= Configuration::updateValue('FIELD_NEWPSL_PAGINATION', 0);
